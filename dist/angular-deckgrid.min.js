...
this.$$templateKeyIndex=0}/**
     ...
     *
     */
return c.prototype.$$link=function(c,d,e,f,g){var h="deckgrid/innerHtmlTemplate"+ ++this.$$templateKeyIndex+".html";angular.isUndefined(e.cardtemplate)?(angular.isUndefined(e.cardtemplatestring)?
...
c.cardTemplate=e.cardtemplate,c.mother=c.$parent,this.$$deckgrid=a.create(c,d[0]),
// Cleanup, will be called when the deckgrid directive should be destroyed
c.$on("$destroy",this.$$deckgrid.destroy.bind(this.$$deckgrid))},{create:function(){return new c}}}]),/*
 * angular-deckgrid
 *
 * Copyright(c) 2013-2014 André König <andre.koenig@posteo.de>
 * MIT Licensed
...
/**
     ...
     *
     */
return c.prototype.$$getMediaQueries=function(){function b(a){try{return a.sheet.cssRules||[]}catch(a){return[]}}function c(a){
